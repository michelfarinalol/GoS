...
OnTick(function()
	...
	if Mix:Mode() == "Combo" then
		...
		if GnarMenu.Combo.MQ:Value() and Ready(_Q) and ValidTarget(target, 1150) and GetCastName(myHero, _Q) == "GnarBigQ" and (GotBuff(myHero, "gnartransformsoon") == 1 or GotBuff(myHero, "gnartransform") == 1) then
			if MQPred and MQPred.hitChance >= (GnarMenu.p.MpQ:Value()/100) then
				CastSkillShot(_Q, MQPred.castPos)
			end
		end
		...
		if GnarMenu.Combo.tE:Value() and Ready(_E) and ValidTarget(target, 475) and GetCastName(myHero, _E) == "GnarBigE" and GotBuff(myHero, "gnartransformsoon") == 1 and GetCurrentMana >= 100 then
	...
	for _,enemy in pairs(GetEnemyHeroes()) do	
		if GnarMenu.KS.Q:Value() and Ready(_Q) and ValidTarget(enemy) and (GotBuff(myHero, "gnartransform") == 0 or GotBuff(myHero, "gnarfuryhigh") == 1) then
		...
		if GnarMenu.KS.MQ:Value() and Ready(_Q) and ValidTarget(enemy) and (GotBuff(myHero, "gnartransformsoon") == 1 or GotBuff(myHero, "gnartransform") == 1) then
			if GetCurrentHP(enemy) + GetDmgShield(enemy) < CalcDamage(myHero, enemy, -40 + 40 * GetCastLevel(myHero, _Q) + myHero.totalDamage * 1.2, 0) then
				if MQPred and MQPred.hitChance >= (GnarMenu.p.MpQ:Value()/100) then
					CastSkillShot(_Q, MQPred.castPos)
				end
			end
		end
		if GnarMenu.KS.W:Value() and Ready(_W) and ValidTarget(enemy) and (GotBuff(myHero, "gnartransformsoon") == 1 or GotBuff(myHero, "gnartransform") == 1) then
		...
		if GnarMenu.KS.E:Value() and Ready(_E) and ValidTarget(enemy) and (GotBuff(myHero, "gnartransformsoon") == 1 or GotBuff(myHero, "gnartransform") == 1) then
